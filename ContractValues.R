...
p <- df4 %>%
  ...
  annotate("text", x = 1, y = 550000, label = "Replacement Level BPM", 
           size = 3, family = "AppleGothic") +
  geom_text(aes(x = 10, y = 1000000, label = TeamUsed), 
            size = 5, family = "AppleGothic") +
  ...
  labs(x = "Adjusted Box Plus/Minus",
       ...
       caption = "basketball-reference.com",
       family = "AppleGothic") +
  ...
  guides(fill = guide_colorbar(
    ...
    nrow = 1))
p
ggsave("ORLChart.png", width = 7, height = 6, dpi = 300)       
